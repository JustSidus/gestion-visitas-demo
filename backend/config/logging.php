...
return [
    ...
    */
    ...
    'channels' => [
        ...
        // Canales especializados para el sistema de visitas
        'security' => [
            'driver' => 'daily',
        ...
        'business' => [
            ...
            'level' => 'info',
            'days' => 180, // Logs de negocio por 6 meses
            'replace_placeholders' => true,
        ],
        ...
        'visits' => [
            'driver' => 'daily',
            'path' => storage_path('logs/visits/visits.log'),
            'level' => 'info',
            'days' => 60,
            'replace_placeholders' => true,
        ],
        ...
        // Canal para alertas críticas (puede integrarse con Slack, email, etc.)
        'alerts' => [
            'driver' => 'stack',
            'channels' => ['daily'], // Slack temporalmente deshabilitado
            'ignore_exceptions' => false,
        ],

        // Canal para métricas y monitoreo
        'metrics' => [
            'driver' => 'daily',
            'path' => storage_path('logs/metrics/metrics.log'),
            'level' => 'info',
            'days' => 90,
            'replace_placeholders' => true,
        ],
